...
import static Logins.Booking_Frame.dummy;
...
public class Wallet_Frame extends javax.swing.JFrame {
   ...
   // Drivers dummy= new Drivers();
    static double[][] cost= {{0,190,240,255,245,275,230},{60,0,75,225,195,240,210},{165,145,0,210,150,145,210},{150,145,210,0,210,150,145},{150,145,210,210,0,150,145},{150,145,210,210,0,150,145},{150,145,210,210,150,145,0}};
    static int[][] time= {{0,20,10,20,25,20, 32},{10,0,20,30,13, 16, 29},{20,11,0,27,25,19,32}, {20,19,17,0,25,20, 32},{19,10,20,25,0,20, 32},{20,11,20,25,29,0, 32},{20,10,19,25,20,32,0}};
    /**
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 51, 0), 10, true));
        jPanel3.setForeground(new java.awt.Color(51, 51, 0));

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel2.setText("Money(INR):");
        jLabel2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 51, 0), 2, true));
        jLabel2.setOpaque(true);

        jLabel3.setBackground(new java.awt.Color(255, 255, 255));
        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel3.setText("Card Number:");
        jLabel3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 51, 0), 2, true));
        jLabel3.setOpaque(true);

        jmoney.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jmoney.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 51, 0), 2, true));
        ...
        jcard.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jcard.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 51, 0), 2, true));
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jmoney, javax.swing.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)
                            .addComponent(jcard)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(225, 225, 225)
    ...
    private void jmoneyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmoneyActionPerformed
         mon= Double.parseDouble(jmoney.getText());
    ...
    public static void Do(){
       ...
       s= Booking_Frame.getS();
       d= Booking_Frame.getD();
       for(Drivers x: d1){
           if(x.present_loc==s){
